...
export const WebsiteFrame: React.FC<Props> = ({ children }) => {
  return (
    <div className="w-full max-w-4xl mx-auto p-2 sm:p-4 my-auto">
      ...
      <div className="relative w-full border-[6px] border-zinc-800 rounded-2xl shadow-2xl bg-zinc-950 text-zinc-100 p-4 sm:p-8 overflow-hidden min-h-[85vh] flex flex-col justify-between">
        
        {/* 2 Sleek Vertical Fading Grid Lines */}
        <div className="absolute top-0 left-10 md:left-16 w-px h-full bg-gradient-to-b from-transparent via-zinc-700/40 to-transparent pointer-events-none z-0" />
        <div className="absolute top-0 right-10 md:right-16 w-px h-full bg-gradient-to-b from-transparent via-zinc-700/40 to-transparent pointer-events-none z-0" />
